...
var BlockchainAwarenessCourseController = require('../controllers/BlockchainAwarenessCourse');
...
module.exports = (app) => {
  ...
  app.post('/upload_blockchainAwarenessCourse', function(req, res) {
      var exceltojson;
      upload(req,res,function(err){
          ...
          try {
              exceltojson({
                  ...
                  blockchainAwarenessCourseController.insertBlockchainAwarenessCourseData(result, (err, response) => {
  ...
  app.get('/upload_blockchainAwarenessCourse', function(req, res) {
