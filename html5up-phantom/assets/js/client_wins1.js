...
function showOpportunityModal(placementId, oppDataObj) {
  ...
  html += '<h5 class="modal-title" id="modalLabel">' + oppDataObj.Title + '</h5>';
  html += '</div>';
